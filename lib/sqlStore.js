  ...
  class ThorinSqlStore extends thorin.Interface.Store {
    ...
    * */
    ...
    init(storeConfig) {
      ...
      this.patch = patchInit(thorin, this[config], this);
    ...
    setup(done) {
      ...
      this.run((e) => {
        ...
        // trigger setup
        calls.push(() => {
          thorin._triggerThorinEvent(thorin.EVENT.SETUP, `store.${this.name}`);
        });

        // apply any patches.
        calls.push(() => {
          return this.patch.sync();
        });
